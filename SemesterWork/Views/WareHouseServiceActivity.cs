...
{
    public class WareHouseServiceActivity : Activity
    {
        public WareHouseServiceActivity(MainWindow window) : base(window)
        {
            ...
            Window._textForm.KeyDown += (sender, args) =>
            {
                if (args.Key == Key.Enter)
                    Window.AddPosition((a, b) => EventHandler.AddPositionForSaving(a), Window._textForm.Text, null);
            };

            Button addPosition = new Button() { Content = LanguageEngine.Language["WareHouseActivity AddPosition"], FontSize = 48 };
            addPosition.Click += (sender, args) => Window.AddPosition((a, b) => EventHandler.AddPositionForSaving(a), Window._textForm.Text, null);
            ...
            EventHandler.StartScannerReceiver(Window.AddPosition, (a, b) => EventHandler.AddPositionForSaving(a));
        }
    }
}